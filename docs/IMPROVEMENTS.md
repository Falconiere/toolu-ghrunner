...
- **Refs:** `toolu-runner/src/listener/helpers.rs:94`, `toolu-runner/src/listener/step_reporter.rs:114`
...
- **Refs:** `toolu-runner/src/listener/job_lifecycle.rs:224`, `toolu-runner/src/listener/job_lifecycle.rs:244`
...
- **Refs:** `shared/src/paths.rs:45`, `shared/src/startup.rs:36`, `toolu-runner/src/main.rs:138`
...
- **Refs:** `toolu-runner/src/net/auth.rs:35`, `toolu-runner/src/net/messages.rs:50`, `toolu-runner/src/net/run_service.rs:38`, `toolu-runner/src/net/session.rs:27`, `toolu-runner/src/net/v1.rs:32`, `toolu-runner/src/net/log_upload.rs:61`
...
- **Refs:** `toolu-runner/src/main.rs:129`, `toolu-runner/src/main.rs:214`, `toolu-runner/src/main.rs:297`, `toolu-runner/src/main.rs:394`, `toolu-runner/src/main.rs:439`
...
- **Refs:** `toolu-runner/src/execution/action_exec.rs:148`, `toolu-runner/src/execution/action_exec.rs:63`

### IMP-CQ-007 — 34 pub items ship without doc comments (house rule violation)
- **Severity:** L | **Effort:** M
- **Rationale:** 34 `pub fn/struct/enum/trait/const` items across `shared/protocol/toolu-runner` have no preceding `///` or `#[doc = …]`. Worst offenders: `protocol/src/v1/types.rs` (7 GHES V1 wire types) and `toolu-runner/src/execution/context.rs` (6 public methods on the central `ExecutionContext`).
- **Fix:** Add `///` doc lines to each of the 34. For `protocol/src/v1/types.rs` in particular, every struct is the V1 wire contract and deserves a one-line description.
- **Refs:** `protocol/src/v1/types.rs:29`, `toolu-runner/src/execution/context.rs:146`, `toolu-runner/src/plugin/registry.rs:14`, `toolu-runner/src/execution/service_lifecycle.rs:60`
...
- **Refs:** `toolu-runner/src/execution/docker_cache.rs:8`, `toolu-runner/src/execution/docker_cache.rs:53`, `toolu-runner/src/execution/mod.rs:19`
...
- **Refs:** `toolu-runner/src/listener/execution_loop.rs:135`, `toolu-runner/src/listener/execution_loop.rs:170`, `toolu-runner/src/listener/log_uploader/upload.rs:80`
...
- **Refs:** `toolu-runner/src/execution/job_runner.rs:31`, `toolu-runner/src/execution/steps_runner.rs:136`, `toolu-runner/src/execution/composite_exec.rs:28`
...
- **Refs:** `toolu-runner/src/execution/actions/resolver.rs:57`
...
- **Refs:** `toolu-runner/src/execution/actions/downloader.rs:33`
...
- **Refs:** `toolu-runner/src/execution/handlers/resolve.rs:29`, `toolu-runner/tests/composite_action_test.rs:180`
...
- **Refs:** `toolu-runner/src/reporting/log_upload.rs:19`
...
- **Refs:** `toolu-runner/src/execution/workflow/job_graph.rs:12`
...
- **Refs:** `toolu-runner/src/execution/workflow/matrix.rs:8`
...
- **Refs:** `toolu-runner/src/lockfile.rs:130`, `toolu-runner/tests/failure_modes_test.rs:88`
...
- **Refs:** `toolu-runner/src/main.rs:354`, `toolu-runner/tests/listener_smoke_test.rs:68`
...
- **Refs:** `toolu-runner/src/execution/command_parser.rs:62`
...
- **Refs:** `toolu-runner/src/execution/file_commands.rs:126`
...
- **Severity:** S | **Effort:** S
- **Rationale:** `cmd_run` in main.rs:298 calls `startup::init` (no redactor) instead of `startup::init_with_redactor`. Same at main.rs:215 (`cmd_register`) and main.rs:395 (`cmd_remove`). The `RedactingMakeWriter` and `RedactingWriter` in `shared/src/startup.rs` are built and tested but never installed — no tracing line is ever masked. Every secret (variables, `ACTIONS_RUNTIME_TOKEN`, registration token, broker body) lands in `_diag/runner.log` unredacted.
...
- **Refs:** `toolu-runner/src/main.rs:298`, `toolu-runner/src/main.rs:338`, `shared/src/startup.rs:174`, `toolu-runner/src/execution/secret_masker.rs:17`
...
- **Refs:** `toolu-runner/src/listener/execution_loop.rs:169`, `toolu-runner/src/listener/log_uploader/streamer.rs:55`
...
- **Refs:** `toolu-runner/src/execution/artifacts/backend.rs:70`, `toolu-runner/src/execution/artifacts/service/handlers.rs:44`
...
- **Refs:** `toolu-runner/src/execution/actions/downloader.rs:59`
...
- **Refs:** `toolu-runner/src/net/auth.rs:38`, `toolu-runner/src/net/session.rs:30`, `toolu-runner/src/main.rs:122`
...
- **Refs:** `toolu-runner/src/execution/command_parser.rs:62`, `toolu-runner/src/execution/handlers/script.rs:141`
...
- **Refs:** `protocol/src/types.rs:66`, `protocol/src/jit_config.rs:10`, `protocol/src/auth.rs:19`
...
- **Refs:** `shared/src/startup.rs:80`, `toolu-runner/src/lockfile.rs:112`, `toolu-runner/src/config.rs:167`

### IMP-SE-010 — `EnvFilter` accepts `RUST_LOG=trace` — user can flip the runner to dump secrets
- **Severity:** M | **Effort:** S
- **Rationale:** `shared/src/startup.rs:222-227` builds the filter from `TOOLU_RUNNER_LOG` → `RUST_LOG` with no lower bound. A workflow / user setting `RUST_LOG=toolu_runner=trace` causes `IMP-SE-008`'s broker body+IV to be written to disk, plus every other debug-level value (masked or not — the masker is unwired anyway).
...
- **Refs:** `shared/src/startup.rs:222`
...
- **Refs:** `toolu-runner/src/listener/execution_loop.rs:135`, `toolu-runner/src/listener/execution_loop.rs:169`, `toolu-runner/src/listener/execution_loop.rs:226`
...
- **Refs:** `toolu-runner/src/net/results_service.rs:156`, `toolu-runner/src/listener/log_uploader/upload.rs:154`, `toolu-runner/src/net/log_upload.rs:75`
...
- **Refs:** `toolu-runner/src/execution/secret_masker.rs:54`, `shared/src/startup.rs:29`
...
- **Refs:** `shared/src/startup.rs:85`, `docs/architecture.md:444`
...
- **Refs:** `toolu-runner/src/listener/job_lifecycle.rs:116`, `toolu-runner/src/listener/job_lifecycle.rs:142`
...
- **Refs:** `toolu-runner/src/lockfile.rs:188`
...
- **Refs:** `toolu-runner/src/execution/expressions/evaluator.rs:64`, `toolu-runner/src/execution/expressions/evaluator.rs:75`, `toolu-runner/src/execution/context.rs:91`
...
- **Refs:** `toolu-runner/src/listener/execution_loop.rs:194`, `toolu-runner/src/listener/helpers.rs:109`
...
- **Refs:** `shared/src/startup.rs:29`, `shared/src/startup.rs:289`, `shared/src/startup.rs:322`
...
- **Refs:** `toolu-runner/src/lockfile.rs:162`, `toolu-runner/src/lockfile.rs:177`
...
- **Severity:** M | **Effort:** S
- **Rationale:** The subagent audit originally flagged this as "README uses `e2e-live`, code uses `live`" — but the actual `toolu-runner/Cargo.toml:89-92` defines `e2e-live` (not `live`). The README is correct. The real bug is in `docs/test-coverage.md:11` which says `cargo test -p toolu-runner --features live -- --ignored` — the feature name is wrong.
...
- **Refs:** `docs/test-coverage.md:11`, `docs/test-coverage.md:19`, `toolu-runner/Cargo.toml:91`
...
- **Severity:** M | **Effort:** S
- **Rationale:** `docs/architecture.md:45` says `src/types/ RunnerConfig (re-exported from shared)`. The actual file `toolu-runner/src/types/config.rs` declares its own struct with the same fields, and `toolu-runner/src/types/mod.rs` re-exports THAT, not the shared one. The two are kept structurally identical by convention, not by code. `CLAUDE.md:199` repeats the same claim.
- **Fix:** Either delete the local struct in `toolu-runner/src/types/config.rs` and `pub use shared::RunnerConfig;` (preferred, single source of truth), or rewrite the doc line to "duplicates `shared::RunnerConfig` for crate-local imports".
- **Refs:** `docs/architecture.md:45`, `CLAUDE.md:199`, `toolu-runner/src/types/config.rs:1`
...
- **Refs:** `README.md:192`, `shared/src/startup.rs:130`, `docs/test-coverage.md:32`
...
- **Refs:** `CHANGELOG.md:208`, `shared/src/startup.rs:126`
...
- **IMP-CQ-A01** — `ResultsCtx` declared `pub` but only used inside the listener module. Fix: `pub(super)` for both the struct and its fields. Refs: `toolu-runner/src/listener/helpers.rs:29`
- **IMP-CQ-A02** — Token prefix (first 10 chars) logged in cleartext on results-service errors. Cross-ref **IMP-SE-015**. Refs: `toolu-runner/src/listener/helpers.rs:131`, `toolu-runner/src/listener/helpers.rs:137`
- **IMP-CQ-A03** — `let _ = std::fs::set_permissions` drops permission-set error silently. Fix: `tracing::warn!` before discarding. Refs: `toolu-runner/src/execution/actions/downloader.rs:93`
- **IMP-CQ-A04** — `ExecutionContext::new_for_test` is the only constructor and is named for tests. Fix: rename to `new()` and add a `#[cfg(test)] with_test_defaults()`. Refs: `toolu-runner/src/execution/context.rs:30`, `toolu-runner/src/execution/job_runner.rs:97`
- **IMP-CQ-A05** — `placeholder pull_to_l1` creates an empty L1 entry after L2 hit, no data transfer. Fix: either implement the transfer or return `Err(Cache("L1->L2 replication not yet implemented"))` so callers see a clear error. Refs: `toolu-runner/src/execution/cache/backend/layered.rs:82`, `toolu-runner/src/execution/cache/backend/remote.rs:121`
- **IMP-CQ-A06** — GHES V1 URL resolvers are protocol-public but never called from production code (the V1 path is half-wired). Fix: add a thin orchestration layer in `listener` that calls `fetch_connection_data → resolve_service_url → fetch_timeline/post_timeline_record`, or demote the resolvers to `#[cfg(test)] pub`. Refs: `protocol/src/v1/discovery.rs:9`, `toolu-runner/src/net/v1.rs:55`
- **IMP-CQ-A07** — `let _ = events.send` pattern duplicated 25+ times to swallow mpsc send errors. Fix: add `fn emit_event(events: &mpsc::Sender<RunnerEvent>, event: RunnerEvent)` helper. Refs: `toolu-runner/src/execution/steps_runner.rs:75`, `toolu-runner/src/execution/job_runner.rs:65`, `toolu-runner/src/listener/execution_loop.rs:172`

### Test gaps

- **IMP-TG-011** — transport header-builders (`block_blob_headers`, `append_block_headers`, `create_append_blob_headers`) not covered by `wiremock`. Fix: add a `#[tokio::test]` asserting the request contains `x-ms-blob-type: BlockBlob` for compressed payloads. Refs: `toolu-runner/src/net/log_upload.rs:12`
- **IMP-TG-012** — `reporting::feature_detection` has no test. Fix: build an `AgentJobRequestMessage` with and without `run_service_url` and assert V2/V1 respectively. Refs: `toolu-runner/src/reporting/feature_detection.rs:37`
- **IMP-TG-013** — V1 service URL resolvers (`log_files_url`, `log_lines_url`, `job_finish_url`, `agent_delete_url`) not covered. Fix: extend `ghes_v1_test` with a test that feeds a `ConnectionData` containing all five V1 GUIDs. Refs: `protocol/src/v1/discovery.rs:25`
- **IMP-TG-014** — `PluginRegistry` behavior beyond construction untested. Fix: add unit tests for dedup (re-registering a name replaces) and `iter()` insertion order. Refs: `toolu-runner/src/plugin/registry.rs:21`
- **IMP-TG-015** — `LocalDiskBackend` (cache LRU) has no test. Fix: add a `#[tokio::test]` that reserves a cache id, uploads 1024 bytes, finalizes, downloads, and asserts roundtrip; plus a second entry that triggers eviction when total > 1024. Refs: `toolu-runner/src/execution/cache/backend/local_disk.rs:33`
- **IMP-TG-016** — `LocalBackend` (artifacts) has no test. Fix: add a default-lane test that uploads 3 chunks, calls `finalize`, then `download`, and asserts the concatenated content equals the concatenated input bytes in order. Refs: `toolu-runner/src/execution/artifacts/backend.rs:57`
- **IMP-TG-017** — cache key + trust classifier untested. Fix: add a default-lane test for `key_matches` covering exact match, trailing-colon prefix match, and non-match. Refs: `toolu-runner/src/execution/cache/key.rs:35`
- **IMP-TG-018** — `PathTranslator` untested. Fix: add a default-lane test calling `to_container(host_workspace.join("foo.txt"))` and asserting `/github/workspace/foo.txt`, plus the reverse. Refs: `toolu-runner/src/docker/path_translator.rs:27`
- **IMP-TG-019** — `hash_files` expression function untested. Fix: add a default-lane test against a tempdir containing two known files, asserting `hash_files(tmp, &["*.txt"])` produces a 64-hex-char SHA-256 string. Refs: `toolu-runner/src/execution/expressions/functions/hash.rs:13`
- **IMP-TG-020** — lex/parser unicode and deep-nesting edge cases untested. Fix: add a default-lane test asserting: hyphenated property `github.event.head-commit` parses; 6-level deep chain evaluates; unterminated string returns `Expression` error. Refs: `toolu-runner/src/execution/expressions/lexer.rs:125`
- **IMP-TG-021** — `is_runner_deregistered` never exercised. Fix: inline test covering both matched (`"404"` + `"RunnerNotFound"`) and unmatched inputs. Refs: `toolu-runner/src/listener/handler.rs:141`

### Security

- **IMP-SE-011** — `SecretMasker.add_secret` does not register base64 / double-JSON / URL-encoded variants. Fix: auto-register `base64(value)`, URL-encoding, single-quote shell escaping, double-quote shell escaping, second pass of JSON escaping. Refs: `toolu-runner/src/execution/secret_masker.rs:67`
- **IMP-SE-012** — OIDC `signing_key` and RSA DER bytes held as plain `Vec<u8>` — no `zeroize` on drop. Fix: wrap in `zeroize::Zeroizing<Vec<u8>>` (or sealed `SecretBytes` newtype). Refs: `toolu-runner/src/execution/oidc/claims.rs:14`, `protocol/src/auth.rs:50`
- **IMP-SE-013** — `validate_bearer` uses `!=` (non-constant-time) — local timing oracle. Fix: `subtle::ConstantTimeEq::ct_eq(...).into()`. Refs: `toolu-runner/src/execution/service_auth.rs:12`
- **IMP-SE-014** — `build_jwt` reads `SystemTime::now()` with no monotonic / skew sanity check. Fix: validate `now` against a recent persisted baseline; refuse to mint if skew > N seconds. Refs: `protocol/src/auth.rs:101`, `toolu-runner/src/execution/oidc/claims.rs:113`
- **IMP-SE-015** — 10-char prefix of `x-actions-results-token` logged on every results-service error. Cross-ref **IMP-CQ-A02** and **IMP-DO-014**. Fix: drop the prefix entirely; if needed, hash via `blake3::hash(token).to_hex()[..8]` for a stable fingerprint. Refs: `toolu-runner/src/listener/helpers.rs:131`
...
- **IMP-PF-A01** — `build_step_env` clones full env `HashMap` per step. Fix: hold merged env in an `Arc<HashMap>` and clone the `Arc` per step. Refs: `toolu-runner/src/execution/context.rs:200`, `toolu-runner/src/execution/steps_runner.rs:134`
- **IMP-PF-A02** — `gzip_lines` uses `writeln!(encoder, "{line}")` per line. Fix: `encoder.write_all(line.as_bytes())?; encoder.write_all(b"\n")?;`. Refs: `toolu-runner/src/listener/log_uploader/upload.rs:80`
- **IMP-PF-A03** — Per-step log uploader mpsc has capacity 4096 — blocks the forwarder on bursts. Fix: raise capacity or drop excess lines into a small overflow buffer. Refs: `toolu-runner/src/listener/log_uploader/streamer.rs:13`
- **IMP-PF-A04** — `event.json` write is synchronous `serde_json::to_string_pretty` on the engine task. Fix: `tokio::task::spawn_blocking` + `serde_json::to_writer_pretty` into a `tokio::fs::File`. Refs: `toolu-runner/src/execution/job_runner.rs:142`
- **IMP-PF-A05** — `PipelineContextData → ExprValue` clones every nested value recursively. Fix: use `Rc<ExprValue>` / `Arc<ExprValue>` for the event subtree. Refs: `toolu-runner/src/execution/expressions/context_data.rs:13`
- **IMP-PF-A06** — `format!("{err}")` in `is_runner_deregistered` allocates just to substring-match. Fix: match on the error variant (add a `RunnerNotFound` variant) or expose HTTP status as a typed field. Refs: `toolu-runner/src/listener/handler.rs:141`
- **IMP-PF-A07** — `load_dotenv` runs on every CLI subcommand including `status`. Fix: skip `.env` for read-only subcommands, or cache in a `OnceLock` per process. Refs: `shared/src/startup.rs:74`, `shared/src/startup.rs:230`
- **IMP-PF-A08** — `poll_message` constructs a fresh URL string every poll. Fix: build the query suffix once (e.g. `static QUERY_SUFFIX: OnceLock<String>`) and concatenate with the broker URL on each call. Refs: `toolu-runner/src/net/messages.rs:35`
- **IMP-PF-A09** — listener tx channel capacity 256 + engine tx capacity 1024 can serialize the pipeline. Fix: bump both (engine to 4096, listener to 1024) and/or add the batching dispatch proposed in `IMP-PF-008`. Refs: `toolu-runner/src/listener/handler.rs:76`, `toolu-runner/src/lib.rs:61`
...
- **IMP-DO-012** — `register --token` help doesn't warn the token is single-use. Fix: update `main.rs:60` doc line to: `/// Short-lived, single-use registration token from Settings → Actions → Runners. Burns on first successful register.` Refs: `toolu-runner/src/main.rs:60`
- **IMP-DO-013** — "registration already exists" error doesn't point at the GH-side runner. Fix: extend the error at `main.rs:235` to include `Visit https://github.com/<owner>/<repo>/settings/actions/runners to remove the previous registration, or pass --replace to overwrite locally (the GH-side runner is not deleted until step 10's unregister call lands).` Refs: `toolu-runner/src/main.rs:232`
- **IMP-DO-014** — `results_service` step-update failure logs OAuth token prefix to stderr. Cross-ref **IMP-SE-015**. Refs: `toolu-runner/src/listener/helpers.rs:131`
- **IMP-DO-015** — `cmd_remove` "another run is in flight" message drops holder's PID/started_at. Fix: at `main.rs:417-422`, parse the lock body and append `Holder PID: <pid>, started_at: <started_at>` to the error. Refs: `toolu-runner/src/main.rs:417`, `README.md:270`
- **IMP-DO-016** — `cmd_run` acquires `.lock` before checking empty `jit_config`. Fix: move the `if jit_config_b64.is_empty()` check (main.rs:345) above the `lockfile::acquire` call (main.rs:330). Refs: `toolu-runner/src/main.rs:330`, `toolu-runner/src/main.rs:345`
- **IMP-DO-017** — `PluginRegistry::new` has no `///` doc line. Fix: add `/// Construct an empty registry. Plugins can be added with [`Self::register`].` Refs: `toolu-runner/src/plugin/registry.rs:14`
- **IMP-DO-018** — `register --once` and `--work` flags are absent from README. Fix: add a 3-row "CLI flags reference" subsection to README.md under the Quick start, listing `--once` (run), `--work` (register), `--runner-group` (register), `--force` (remove), `--replace` (register). Refs: `README.md:12`, `toolu-runner/src/main.rs:88`
...
- **IMP-DO-021** — Step handler dispatch description in docs is inconsistent (CLAUDE vs `handlers/mod.rs`). Fix: align `handlers/mod.rs:13` with CLAUDE.md:49 (plugin is a real entry point via the `PluginRegistry`). Refs: `CLAUDE.md:49`, `toolu-runner/src/execution/handlers/mod.rs:11`
- **IMP-DO-022** — `docs/architecture.md:154` session delete semantics claim is vague. Fix: replace with: `Status non-2xx on delete returns RunnerError::Protocol; transport errors propagate. The caller in listener/helpers.rs:105 logs and continues (broker may have expired the session already).` Refs: `docs/architecture.md:154`, `toolu-runner/src/net/session.rs:44`
