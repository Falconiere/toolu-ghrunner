//! Async transport for the GitHub Actions results Twirp service.
//!
//! Twirp RPCs are JSON-over-HTTP POSTs with a fixed URL convention:
//! `{base}/{service_path}/{method}`. Helpers here wrap that convention
//! and keep the auth/header wiring in one place.

use serde::Serialize;

use shared::RunnerError;

// Re-export the Twirp request/response types so callers don't have to
// learn the reporting/ → net/ hop.
pub use crate::reporting::results_service::{
