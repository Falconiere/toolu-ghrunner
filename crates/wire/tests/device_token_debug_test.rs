...
const SECRET: &str = "gho_fake0123456789abcdef0123456789ab";

/// A realistic GitHub device-flow success body, as returned by
/// `POST /login/oauth/access_token` with `Accept: application/json`.
const SUCCESS_BODY: &str = r#"{"access_token":"gho_fake0123456789abcdef0123456789ab","token_type":"bearer","scope":"repo,workflow"}"#;
