...
| `prefetch.rs` | `ActionFetcher` | Shares single-flight fetches between job-start prefetch and step-time execution; completed archives use the `<16-character API-host hash>/<owner>/<repo>/<resolved SHA>` cache path. |
